...
def drawBox(img,bbox):
    ...
    x,y,w,h = int(bbox[0]),int(bbox[1]),int(bbox[2]),int(bbox[3])
    cv2.rectangle(img,(x,y),((x+w),(y+h)),(225,0,0),3,1)
    cv2.putText(img,"Tracking",(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(225,225,0),2)
...
while True:
   #Write the code inside loop here
    ...
    if success :
        ...
        cv2.putText(img,"lost",(75,90),cv2.FONT_HERSHEY_COMPLEX,0.7,(225,225,0),2)
